...
const SUPER_ADMIN = "rajasaipranav0@gmail.com";
          ...
          <ul className="space-y-2">
            {admins.map((a) => {
              ...
              return (
                <li
                  key={a._id}
                  className={`flex items-center justify-between py-2.5 px-3 rounded-lg bg-[#0a0a0a] border ${
                    isSuper ? "border-green-500/30" : "border-gray-900"
                  }`}
                >
                  <div className="flex items-center gap-2.5">
                    {isSuper && (
                      <Crown size={13} className="text-green-400 shrink-0" />
                    )}
                    <div>
